    ...
    <section className="relative w-full min-h-screen bg-gradient-to-b from-[#0f172a] to-[#1e293b] text-white overflow-hidden">
      ...
      <div className="relative z-20 w-full px-4 md:px-8 pt-16 flex flex-col items-center h-full">
        <div className="w-full max-w-3xl text-center py-12 space-y-6">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-['Labora_Rounded'] leading-tight tracking-tight">
            {content.hero.title},&nbsp;
            <span className="text-blue-400 font-['Labora_Rounded']">
              {content.hero.highlight}
            </span>
          </h1>
          <p className="text-gray-300 sm:text-lg font-['Labora_Rounded']">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button size="lg" asChild>
              <Link
                href="/signup"
                className="text-white font-['Labora_Rounded']"
              >
            ...
            >
              <Link
                href="#how-it-works"
                className="flex items-center text-white bg-transparent border border-blue-500 hover:bg-blue-500/10 transition-colors duration-200 font-['Labora_Rounded']"
              >
        ...
        <div className="w-full flex justify-center py-12 px-4">
          <div className="w-full max-w-xl bg-[#1e293b] rounded-xl shadow-2xl overflow-hidden border border-gray-700">
            <div className="flex items-center gap-2 px-4 py-2 bg-[#0f172a] border-b border-gray-700">
              ...
              <p className="ml-4 text-sm text-gray-400 truncate font-['Labora_Rounded']">
